...
class DisplayModuleTest(unittest.TestCase):
    ...
    def test_get_caption(self):
        ...
        screen = screen.set_mode((100, 100))
        self.assertEqual(screen.get_caption()[0], self.default_caption)
    ...
    def test_set_caption(self):
        ...
        TEST_CAPTION = "test"
        screen = screen.set_mode((100, 100))
        self.assertIsNone(screen.set_caption(TEST_CAPTION))
        self.assertEqual(screen.get_caption()[0], TEST_CAPTION)
        self.assertEqual(screen.get_caption()[1], TEST_CAPTION)

    def test_caption_unicode(self):
        TEST_CAPTION = u'台'
        screen.set_caption(TEST_CAPTION)
        import sys
        if sys.version_info.major >= 3:
            self.assertEqual(screen.get_caption()[0], TEST_CAPTION)
        else:
            self.assertEqual(unicode_(screen.get_caption()[0], 'utf8'), TEST_CAPTION)
